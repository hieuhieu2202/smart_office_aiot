    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: Obx(() {
          ...
          // Chiều cao ỔN ĐỊNH cho bảng
          final media = MediaQuery.of(context);
          final totalH = media.size.height;
          final topPad = media.padding.top;
          // padding vertical: fromLTRB(12,12,12,16) => 28
          const sliverVertPadding = 28.0;
          // trừ AppBar + padding top + padding sliver
          final rawTableH = totalH - kToolbarHeight - topPad - sliverVertPadding;
          // trừ thêm 12px để tránh sai số làm tràn
          final tableH = (rawTableH - 12).clamp(200.0, totalH).toDouble();
