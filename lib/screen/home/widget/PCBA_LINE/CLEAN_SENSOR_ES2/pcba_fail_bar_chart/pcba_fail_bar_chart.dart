...
const double _bottomReserve   = 20.0;
const double _bottomSafePad   = 2.0;
const double _outsideIfShortPx = 24.0;

class PcbaFailBarChart extends StatelessWidget {
  final PcbaLineDashboardController controller;
  const PcbaFailBarChart({super.key, required this.controller});
                ...
                IgnorePointer(
                  child: Stack(
                    children: List.generate(n, (i) {
                      final y = controller.passFailPoints[i].fail.toDouble();
