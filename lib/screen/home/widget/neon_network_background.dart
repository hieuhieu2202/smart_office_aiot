...
class _NeonNetworkBackdropState extends State<NeonNetworkBackdrop>
  ...
  static const int _minNodes = 48;
  static const int _maxNodes = 96;
  static const double _maxSpeed = 28;
  static const int _maxLinksPerNode = 4;
  ...
  void _seedNodes() {
    ...
    final double density = (area / 32000)
              ...
              RepaintBoundary(
                child: CustomPaint(
                  painter: _NeonNetworkPainter(
                    ...
                    maxLinksPerNode: _maxLinksPerNode,
  ...
  double _computeLinkDistance() {
    ...
    final double base = math.min(_viewport.width, _viewport.height) * 0.32;
    return base.clamp(80.0, 140.0);
  }
}
  ...
  void paint(Canvas canvas, Size size) {
    ...
    for (int i = 0; i < nodes.length; i++) {
      ...
      for (int j = i + 1; j < nodes.length; j++) {
        ...
        if (connections >= maxLinksPerNode) {
          break;
        }
